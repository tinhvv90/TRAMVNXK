...
//    Add to cart Animation
    ...
    func addProductAnimation(imageView: UIImageView) {
...
// MARK: - Add items to the lower right corner cart Animation (Thêm các mục vào góc dưới bên phải giỏ Animation)
