...
public class DictModelManager {
    ...
    ///  Create a custom array of objects
    ///
    ...
    ///  Loading complete class information
    ///
    ///  - parameter cls: Model Class
    ///
    ///  - returns: For complete information model class
